/**
 * Shared Tool-node reader: resolves one root or nested Tool lifecycle through
 * the internal Chat Node index. Used by the chat view renderers and the
 * skeleton's approval/details panels.
 */
import type {
