 ...
 *
 * The shared cross-domain faces (DraftAttachmentId, InputState,
 * SessionInput, …) live in contract/input.ts; this file re-exports them and
 * keeps the machine-internal event/effect types.
 */
import type {
  CommandClaim, ConsumeTokenRequest, PickOutcome,
...
export type {
  ComposerKeyboard, DraftAttachmentId, EditRange, EditSelection, InputActions, InputNotice,
  InputState, InputTarget, Occurrence, PasteAttemptState, PasteComponent, QueuedMessage,
  SessionInput, SessionInputResolver,
} from '../contract/input.ts'
