...
import { billedInputTokens, cacheHitPercent, formatDuration, formatTokens } from '../contract/stats.ts'
import { formatTokensPerSecond } from './message-chrome.ts'
import { assistantStepReading } from './turn-metrics.ts'
import css from './StatsLine.module.css'

// Re-export the shared display helpers so chat-domain consumers (and tests
// importing this component file) keep resolving them.
export { billedInputTokens, cacheHitPercent, contextOccupancy, formatDuration, formatTokens } from '../contract/stats.ts'
