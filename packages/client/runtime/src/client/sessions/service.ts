...
import { createScope, scopeOf as scopeTagOf } from '../contract/scope.ts'
...
// SessionSummary / SessionListState now live in contract/sessions.ts (shared
// session contract faces); re-exported here so existing consumers keep their
// import site.
export type { SessionSummary, SessionListState } from '../contract/sessions.ts'
...
// SessionBinding now lives in contract/sessions.ts; the scope primitives now
// live in contract/scope.ts. Both are re-exported here so existing consumers
// keep their import site.
export type { SessionBinding } from '../contract/sessions.ts'
export { scopeOf } from '../contract/scope.ts'
...
// SessionProvideContribution / SessionProvideDescriptor now live in
// contract/sessions.ts; re-exported here so existing consumers keep their
// import site.
export type {
  SessionProvideContribution, SessionProvideDescriptor,
} from '../contract/sessions.ts'
