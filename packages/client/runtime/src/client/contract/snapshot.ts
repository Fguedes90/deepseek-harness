...
// convenient).
//
// This is the shared snapshot contract: the sessions domain assembles it and
// the `useSession` selector hook consumes it, so it lives in contract/ and is
// re-exported by sessions/conversation.ts (its implementation home).
