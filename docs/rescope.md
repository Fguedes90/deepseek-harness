...
- **Prose outside `docs/`.** `vendor/*/README.md`, package READMEs, and Agent Notes keep the names they were written with; a bare `cordis` there can also be an agent-preset id. Inside `docs/`, prose and every Markdown fence follow the rename.
