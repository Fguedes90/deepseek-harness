...
Binaries are git-ignored and built natively per architecture — locally for your own machine, by CI's per-arch runners as the builders of record. Pack rehearsal: [docs/release.md](docs/release.md).
