...
- Public JSDoc, package READMEs, architecture and subsystem docs, generated catalogs, examples, and session fixtures use provider/model targets consistently and are checked by the repository documentation and type-equivalence gates.
