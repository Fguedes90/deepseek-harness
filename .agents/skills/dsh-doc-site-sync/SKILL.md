...
Repository Markdown is the only content source; the website is English-only. Never create locale directories for website content. Each canonical English Markdown file maps one-to-one to a public route through the publication manifest.
