 ...
 * repeat it as the last element under the page.
 *
 ...
 * @param markdown Rewritten canonical Markdown content.
 * @param page Publication manifest entry for the content.
 * @returns Full Markdown for ordinary pages or frontmatter-only Markdown for a home page.
 */
  ...
  for (const page of docsPages) {
    ...
    const projected = rewriteMarkdown(markdown, {
      ...
      placeImage: (absPath) => {
        ...
        // relative URL is correct from the page.
