/**
 * Coverage for the generated cordis-surface region splice (`spliceRegion`):
 * the marker grammar is generic, so regeneration replaces exactly the one
 * region this generator owns and fails loud on any other page's markers.
 */
