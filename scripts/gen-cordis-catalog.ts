 ...
 * and fails loud when the committed region drifts. The
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshPatchPath: 'not a service: boot-provided profile patch-layer path (string | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PluginEntryId: 'Loader entry identity is owned by packages/host/plugin-inventory/README.md',
